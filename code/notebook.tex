...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
/home/ubuntu/miniconda3/envs/RoboND/lib/python3.5/site-packages/h5py/\_\_init\_\_.py:36: FutureWarning: Conversion of the second argument of issubdtype from `float` to `np.floating` is deprecated. In future, it will be treated as `np.float64 == np.dtype(float).type`.
...
layer. For example, 32 or 64.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{def} \PY{n+nf}{encoder\PYZus{}block}\PY{p}{(}\PY{n}{input\PYZus{}layer}\PY{p}{,} \PY{n}{filters}\PY{p}{,} \PY{n}{strides}\PY{p}{)}\PY{p}{:}
...
{\color{incolor}In [{\color{incolor}5}]:} \PY{k}{def} \PY{n+nf}{decoder\PYZus{}block}\PY{p}{(}\PY{n}{small\PYZus{}ip\PYZus{}layer}\PY{p}{,} \PY{n}{large\PYZus{}ip\PYZus{}layer}\PY{p}{,} \PY{n}{filters}\PY{p}{)}\PY{p}{:}
            ...
            \PY{n}{upsampled} \PY{o}{=} \PY{n}{bilinear\PYZus{}upsample}\PY{p}{(}\PY{n}{small\PYZus{}ip\PYZus{}layer}\PY{p}{)}
            
            \PY{c+c1}{\PYZsh{} TODO Concatenate the upsampled and large input layers using layers.concatenate}
            \PY{n}{concat\PYZus{}layer} \PY{o}{=} \PY{n}{layers}\PY{o}{.}\PY{n}{concatenate}\PY{p}{(}\PY{p}{[}\PY{n}{upsampled}\PY{p}{,} \PY{n}{large\PYZus{}ip\PYZus{}layer}\PY{p}{]}\PY{p}{)}
            
            \PY{c+c1}{\PYZsh{} TODO Add some number of separable convolution layers}
            \PY{n}{output\PYZus{}layer} \PY{o}{=} \PY{n}{separable\PYZus{}conv2d\PYZus{}batchnorm}\PY{p}{(}\PY{n}{concat\PYZus{}layer}\PY{p}{,} \PY{n}{filters}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}6}]:} \PY{k}{def} \PY{n+nf}{fcn\PYZus{}model}\PY{p}{(}\PY{n}{inputs}\PY{p}{,} \PY{n}{num\PYZus{}classes}\PY{p}{)}\PY{p}{:}
            ...
            \PY{c+c1}{\PYZsh{} Add Encoder Blocks. }
            \PY{c+c1}{\PYZsh{} Remember that with each encoder layer, the depth of your model (the number of filters) increases.}
            \PY{c+c1}{\PYZsh{} The shrinking of the layers ia achieved by changing stride}
            \PY{c+c1}{\PYZsh{} We also use more depth as illustrated by 32 and then 64}
            \PY{c+c1}{\PYZsh{} Initially I had 16 and 32 and the higher values perform much better without incurring too much of a cost}
            \PY{n}{l1} \PY{o}{=} \PY{n}{encoder\PYZus{}block}\PY{p}{(}\PY{n}{inputs}\PY{p}{,} \PY{l+m+mi}{32}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}
            \PY{n}{l2} \PY{o}{=} \PY{n}{encoder\PYZus{}block}\PY{p}{(}\PY{n}{l1}\PY{p}{,} \PY{l+m+mi}{64}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}
        
            \PY{c+c1}{\PYZsh{} Add 1x1 Convolution layer using conv2d\PYZus{}batchnorm().}
            \PY{c+c1}{\PYZsh{} This is implemented as regular convo so set stride and kernel to 1 for it to be 1x1}
            \PY{n}{l3} \PY{o}{=} \PY{n}{conv2d\PYZus{}batchnorm}\PY{p}{(}\PY{n}{l2}\PY{p}{,} \PY{l+m+mi}{64}\PY{p}{,} \PY{n}{kernel\PYZus{}size}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{strides}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
            
            \PY{c+c1}{\PYZsh{} Add the same number of Decoder Blocks as the number of Encoder Blocks}
            \PY{c+c1}{\PYZsh{} Add decoder blocks and the skip layer connections}
            \PY{c+c1}{\PYZsh{} If you look at the implementation of the decoder the elementwise addition is happening}
            \PY{c+c1}{\PYZsh{} after the upsample. So we have to connect the layers of correct size.}
            \PY{n}{l4} \PY{o}{=} \PY{n}{decoder\PYZus{}block}\PY{p}{(}\PY{n}{l3}\PY{p}{,} \PY{n}{l1}\PY{p}{,} \PY{l+m+mi}{64}\PY{p}{)}
            \PY{n}{l5} \PY{o}{=} \PY{n}{decoder\PYZus{}block}\PY{p}{(}\PY{n}{l4}\PY{p}{,} \PY{n}{inputs}\PY{p}{,} \PY{l+m+mi}{32}\PY{p}{)}
            ...
            \PY{k}{return} \PY{n}{layers}\PY{o}{.}\PY{n}{Conv2D}\PY{p}{(}\PY{n}{num\PYZus{}classes}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{,} \PY{n}{activation}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{softmax}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{padding}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{same}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{(}\PY{n}{x}\PY{p}{)}
\end{Verbatim}
...
work with.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{} initial learning rate = 0.1}
        \PY{n}{learning\PYZus{}rate} \PY{o}{=} \PY{l+m+mf}{0.001}
        \PY{n}{batch\PYZus{}size} \PY{o}{=} \PY{l+m+mi}{30}
        \PY{n}{num\PYZus{}epochs} \PY{o}{=} \PY{l+m+mi}{80}
        \PY{c+c1}{\PYZsh{}did not tweak these values}
        \PY{n}{steps\PYZus{}per\PYZus{}epoch} \PY{o}{=} \PY{l+m+mi}{200}
...
199/200 [============================>.] - ETA: 5s - loss: 0.3413 
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
200/200 [==============================] - 1117s - loss: 0.3399 - val\_loss: 0.1034
Epoch 2/80
...
199/200 [============================>.] - ETA: 4s - loss: 0.0237
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_19_103.png}
    \end{center}
    { \hspace*{\fill} \\}
...
199/200 [============================>.] - ETA: 4s - loss: 0.0236
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_19_109.png}
    \end{center}
    { \hspace*{\fill} \\}
...
199/200 [============================>.] - ETA: 4s - loss: 0.0237
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_19_115.png}
    \end{center}
    { \hspace*{\fill} \\}
...
199/200 [============================>.] - ETA: 4s - loss: 0.0227
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_19_121.png}
    \end{center}
    { \hspace*{\fill} \\}
...
199/200 [============================>.] - ETA: 4s - loss: 0.0238
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_19_127.png}
    \end{center}
    { \hspace*{\fill} \\}
...
199/200 [============================>.] - ETA: 4s - loss: 0.0231
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_19_133.png}
    \end{center}
    { \hspace*{\fill} \\}
...
199/200 [============================>.] - ETA: 4s - loss: 0.0215
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_19_139.png}
    \end{center}
    { \hspace*{\fill} \\}
...
199/200 [============================>.] - ETA: 4s - loss: 0.0233
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_19_145.png}
    \end{center}
    { \hspace*{\fill} \\}
...
199/200 [============================>.] - ETA: 4s - loss: 0.0220
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_19_151.png}
    \end{center}
    { \hspace*{\fill} \\}
...
199/200 [============================>.] - ETA: 4s - loss: 0.0225
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
200/200 [==============================] - 1000s - loss: 0.0225 - val\_loss: 0.0278
Epoch 79/80
199/200 [============================>.] - ETA: 4s - loss: 0.0224
    \end{Verbatim}

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_19_157.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{Verbatim}[commandchars=\\\{\}]
200/200 [==============================] - 1000s - loss: 0.0224 - val\_loss: 0.0292
Epoch 80/80
199/200 [============================>.] - ETA: 4s - loss: 0.0215
    \end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
200/200 [==============================] - 1000s - loss: 0.0215 - val\_loss: 0.0329

    \end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}9}]:} <tensorflow.contrib.keras.python.keras.callbacks.History at 0x7f19be333d30>
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{c+c1}{\PYZsh{} Save your trained model weights}
...
identify the target while following them.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{\PYZsh{} If you need to load a model which you previously trained you can uncomment the codeline that calls the function below.}
...
it for different runs. For example, `run\_1', `run\_2' etc.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{n}{run\PYZus{}num} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{run\PYZus{}1}\PY{l+s+s1}{\PYZsq{}}
...
some sample images from the predictions in the validation set.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{c+c1}{\PYZsh{} images while following the target}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{c+c1}{\PYZsh{} images while at patrol without target}
...
discussed during the Prediction step.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{c+c1}{\PYZsh{} Scores for while the quad is following behind the target. }
...
number true positives: 539, number false positives: 0, number false negatives: 0
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{\PYZsh{} Scores for images while the quad is on patrol and the target is not visable}
...
number true positives: 0, number false positives: 58, number false negatives: 0
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{c+c1}{\PYZsh{} This score measures how well the neural network can detect the target from far away}
...
number true positives: 126, number false positives: 1, number false negatives: 175
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{c+c1}{\PYZsh{} Sum all the true positives, etc from the three datasets to get a weight for the score}
...
0.7397107897664071
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{c+c1}{\PYZsh{} The IoU for the dataset that never includes the hero is excluded from grading}
...
0.5059571999538675
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{c+c1}{\PYZsh{} And the final grade score is }
